...
const ALLOWED_SOURCES = new Set(["chat_api", "free_time", "work_packet_signal", "operator_note_wake", "unknown"]);
...
function optionalSource(value: unknown) {
  ...
  if (!ALLOWED_SOURCES.has(source)) {
    throw new Error('source must be "chat_api", "free_time", "work_packet_signal", "operator_note_wake", or "unknown".');
  }
